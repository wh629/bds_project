...
MODEL=albert-xxlarge-v2 # 'bert-base-uncased', 'bert-large-uncased', 'roberta-base', 'roberta-large', 'albert-base-v2', 'albert-xxlarge-v2', 'albert-base-v1', 'albert-xxlarge-v1'
LENGTH=512
CAPACITY=2
PATIENCE=5
